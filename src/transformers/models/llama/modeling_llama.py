    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.softmax_bw is not None:
            hidden_states = custom_int_rmsnorm(hidden_states, self.input_layernorm.weight, self.variance_epsilon, self.softmax_bw)
        else:
        ...
        residual = hidden_states
        if self.softmax_bw is not None:
            hidden_states = custom_int_rmsnorm(hidden_states, self.post_attention_layernorm.weight, self.variance_epsilon, self.softmax_bw)
        else:
            # hidden_states = self.ln_cross_attn(hidden_states)
